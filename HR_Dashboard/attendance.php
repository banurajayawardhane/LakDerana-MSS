    ...
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        ...
        if (isset($_POST['submit']))
        {
          ...
          {
            $query = "SELECT * FROM attendance where `status`='$fstatus' AND `user_id`='$fid' AND `date`='$fdate' order by `date` DESC";
            $query_run = mysqli_query($conn, $query);
          }
          elseif($fid !="" && $fstatus !="")
          {
            $query = "SELECT * FROM attendance where `status`='$fstatus' AND `user_id`='$fid' order by `date` DESC";
            $query_run = mysqli_query($conn, $query);
          }
          ...
          elseif($fid != "")
          {
            $query = "SELECT * FROM attendance where `user_id`='$fid' order by `date` DESC";
            $query_run = mysqli_query($conn, $query);
          }
          elseif($fstatus !="")
          {
