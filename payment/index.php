          ...
          <div class="container">
               ...
               <form autocomplete="off" action="checkout-charge.php" method="POST" class="login-email">
                    ...
                    <div class="input-group">
                         <input type="text" placeholder="Enter License Number Or ID Number" name="email" value="Reservation No: <?php echo $_GET["item_name"]?>" required>
                    </div>
                    <div class="input-group">
                         <input type="text" placeholder="Enter Password" name="password" value="Amount: Rs.<?php echo $_GET["price"]?>" required>
                    </div>
                    <div class="input-group">
                         <input type="text" placeholder="Enter Password" name="password" value="Customer ID:  <?php echo $_GET["license_number"]?>" required>
                    </div>
